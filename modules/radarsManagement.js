...
const createNewRadar = () => {
    ...
    if (ratingTypeName != null && ratingTypeName.length > 0) {
        // new rating type
        ratingType = { id: uuidv4(), name: ratingTypeName, label: ratingTypeName, properties: {}, timestamp: Date.now() }
        ...
        if (objectTypeName != null && objectTypeName.length > 0) {
            ...
            objectType = { id: uuidv4(), name: objectTypeName, label: objectTypeName, properties: {}, timestamp: Date.now() }
